...
public class Map implements ActionListener{
	...
	private void addInstructions(Box instructBox) {
		...
		instructBox.add(new JLabel(" Walkers (circles) wander randomly about.", SwingConstants.LEFT));
		instructBox.add(new JLabel(" Pillars (triangles) change color occasionally.", SwingConstants.LEFT));
	...
	/** Put bl block, wa walkers, and pi pillars on the map.
	...
	/** Make every piece in the map act. When all have acted,
